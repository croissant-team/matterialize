#ifndef MATTERIALIZE_MATTER_TYPE_HPP
#define MATTERIALIZE_MATTER_TYPE_HPP
...
public:
  static MatterConfig default_for(IMatterMode &mode);
...
#endif// MATTERIALIZE_MATTER_TYPE_HPP
