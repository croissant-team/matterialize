...
protected:
  ...
  IMatterConfigField(const char *name, bool must_reinit_on_update)
      : name{name}, must_reinit_on_update{must_reinit_on_update} {};
};
...
public:
  MatterConfigFieldString(
      const char *name, bool must_reinit, const char *default_value)
      : IMatterConfigField{name, must_reinit}, default_value{default_value} {}
};
